...
declare -A online_music=(
  ...
  ["Radio - Lofi Girl 🎧🎶"]="https://www.youtube.com/watch?v=jfKfPfyJRdk"
...
populate_local_music() {
  ...
  done < <(find "$mDIR" -type f \( -iname "*.mp3" -o -iname "*.flac" -o -iname "*.wav" -o -iname "*.ogg" -o -iname "*.mp4" -o -iname "*.opus" \))
}
